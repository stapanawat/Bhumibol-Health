...
const form = useForm({
    _method: 'PUT',
    name_th: props.doctor.name_th,
    name_en: props.doctor.name_en,
    specialty_th: props.doctor.specialty_th,
    specialty_en: props.doctor.specialty_en,
    education_th: props.doctor.education_th,
    education_en: props.doctor.education_en,
    department: props.doctor.department,
    order: props.doctor.order,
...
const photoPreview = ref<string | null>(props.doctor.image ? `/storage/${props.doctor.image}` : null);
                    ...
                    <form @submit.prevent="submit">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input v-model="form.specialty_th" type="text" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" required>
                            ...
                            <div class="col-span-2 md:col-span-1">
                                ...
                                <input v-model="form.specialty_en" type="text" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                <div v-if="form.errors.specialty_en" class="text-red-500 text-xs mt-1">{{ form.errors.specialty_en }}</div>
                            </div>
                            
                            <div class="col-span-2 md:col-span-1">
                                <label class="block text-sm font-medium text-gray-700">Department</label>
                                <input v-model="form.department" type="text" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
