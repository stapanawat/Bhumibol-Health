...
const form = useForm({
    ...
    start_date: props.theme.start_date ? new Date(props.theme.start_date).toISOString().slice(0, 16) : '',
    end_date: props.theme.end_date ? new Date(props.theme.end_date).toISOString().slice(0, 16) : '',
    status: Boolean(props.theme.status),
    css_overrides: props.theme.css_overrides || '',
});
    ...
    <AppSidebarLayout>
        <div class="max-w-4xl mx-auto space-y-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold tracking-tight">Edit Theme</h2>
                    <p class="text-muted-foreground">Update festival or seasonal theme.</p>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="grid gap-6 p-6 border rounded-lg bg-card">
                    ...
                    <div class="space-y-2">
                        ...
                        <div v-if="theme.background_image" class="mb-2">
                            <img :src="theme.background_image" class="h-20 w-auto rounded border" />
                        </div>
                ...
                <div class="grid gap-6 p-6 border rounded-lg bg-card">
                    ...
                    <div class="space-y-2">
                        ...
                        <Textarea id="css_overrides" v-model="form.css_overrides" rows="5" class="font-mono text-sm" />
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-4">
                    ...
                    <Button type="submit" :disabled="form.processing">
                        ...
                        {{ form.processing ? 'Saving...' : 'Update Theme' }}
                    </Button>
                </div>
            </form>
        </div>
